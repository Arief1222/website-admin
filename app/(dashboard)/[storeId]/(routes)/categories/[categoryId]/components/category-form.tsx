...
export const CategoryForm: React.FC<CategoryFormProps> = ({
    ...
    const description = initialData ? "Edit your category details" : "Add a new category to your store";
    ...
    const onSubmit = async (data: CategoryFormValue) => {
        try {
            ...
            toast.error("Something went wrong while updating the category settings")
        } finally {
            setLoading(false)
        }
    }
    ...
    return (
        <>
            <AlertModal
                ...
                onConfirm={onDelete} loading={false} />
